...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/farinchan/ejournal-site@main/css/modal-enhancement.css">
    ...
    <style>
        ...
        .ltn__team-item-3-2:hover .team-info h4 a {
            color: #667eea;
        }
        
        /* Fix webkit line-clamp compatibility */
        .team-info h4 {
            display: -webkit-box;
            -webkit-line-clamp: 3;
            line-clamp: 3;
        ...
        <div class="ltn__team-area pt-120 pb-90---">
            <div class="" style="margin-left: 30px; margin-right: 30px;">
                ...
                <div class="ltn__gallery-active row ltn__gallery-style-1">
                    ...
                    <div class="ltn__gallery-item col-md-3 col-lg-2" id="filter_{$journal->getPath()|escape}">
                        <div class="ltn__team-item ltn__team-item-3 ltn__team-item-3-2 filter_category_3">
                            <div class="team-img">
                                <a href="#" data-toggle="modal" data-target="#{$journal->getPath()|escape}">
                                    ...
                                    <img src='{$journalFilesPath}{$journal->getId()}/{$thumb.uploadName|escape:"url"}'
                                        alt="Image"
                                        style="aspect-ratio: 201/284; width: 100%; height: auto; object-fit: cover; transition: transform 0.3s ease;">
                                    {else}
                                    <img src="https://res.cloudinary.com/duuawbwih/image/upload/v1747042342/Desain_tanpa_judul_1_nr0kdz.png"
                                        alt="Image" style="aspect-ratio: 201/284; width: 100%; height: auto; object-fit: cover; transition: transform 0.3s ease;">
                            ...
                            <div class="team-info">
                                <h4>
                                    <a href="{$url|escape}">{$journal->getLocalizedName()|escape}</a>
                                </h4>
                                <div id="icon_{$journal->getPath()|escape}"> </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="ltn__team-details-member-info text-center ">
                                                        ...
                                                        <div class="journal-badge-container mb-3">
                                                            <span class="badge badge-primary">Academic Journal</span>
                                                            <span class="badge badge-success">Open Access</span>
                                                        </div>
                                                        <div
